...
Register_Enum(macPibIdentifier_t, (macPibIdentifier_t::MAC_ACK_WAIT_DURATION, macPibIdentifier_t::MAC_ASSOCIATED_OWPAN_COORD, macPibIdentifier_t::MAC_ASSOCIATED_PERMIT, macPibIdentifier_t::MAC_AUTO_REQUEST, macPibIdentifier_t::MAC_BEACON_PAYLOAD, macPibIdentifier_t::MAC_BEACON_PAYLOAD_LENGTH, macPibIdentifier_t::MAC_BEACON_ORDER, macPibIdentifier_t::MAC_BEACON_TX_TIME));
...
Register_Enum(phyPIBAttribute_t, (phyPIBAttribute_t::PHY_CURRENT_CHANNEL, phyPIBAttribute_t::PHY_CCA_MODE, phyPIBAttribute_t::PHY_DIM, phyPIBAttribute_t::PHY_USE_EXTENDED_MODE, phyPIBAttribute_t::PHY_COLOR_FUNCTION, phyPIBAttribute_t::PHY_BLINKING_NOTIFICATION_FREQUENCY, phyPIBAttribute_t::PHY_OCC_ENABLE, phyPIBAttribute_t::PHY_OCC_MCS_ID, phyPIBAttribute_t::PHY_PSDU_LENGTH));
